package bzu.skyn.travehelper.controls;
...
public abstract class CarouselAdapter<T extends Adapter> extends ViewGroup {
	...
	public interface OnItemClickListener {
		 ...
		 * 
		 * @param parent
		 *            The CarouselAdapter where the click happened.
		 * @param view
		 *            The view within the CarouselAdapter that was clicked (this
		 ...
		 */
		void onItemClick(CarouselAdapter<?> parent, View view, int position,
				long id);
	...
	public interface OnItemLongClickListener {
		 ...
		 */
		boolean onItemLongClick(CarouselAdapter<?> parent, View view,
	...
	public interface OnItemSelectedListener {
		 ...
		 * 
		 * @param parent
		 *            The CarouselAdapter where the selection happened
		 * @param view
		 *            The view within the CarouselAdapter that was clicked
		 * @param position
		 *            The position of the view in the adapter
		 ...
		 */
		void onItemSelected(CarouselAdapter<?> parent, View view, int position,
				long id);
		 ...
		 * 
		 * @param parent
		 *            The CarouselAdapter that now contains no selected item.
		 */
	...
	public void addView(View child) {
		throw new UnsupportedOperationException(
				"addView(View) is not supported in CarouselAdapter");
	}
	 ...
	 *            be visible in this CarouselAdapter at the time of the call.
	...
	public void setOnClickListener(OnClickListener l) {
		throw new RuntimeException(
				"Don't call setOnClickListener for an CarouselAdapter. "
